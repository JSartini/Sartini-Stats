...
-   [rGCI](https://jsartini.github.io/rGCI/) \| Supporting R software for calculation of the novel Glucose Color Index (GCI) frequency-domain summary of Continuous Glucose Monitoring Data. Includes tools for calculating the smoothed log-periodogram using two weeks of glucose data, summarizing this function into 6 measures using a piece-wise linear model, and finally producing the GCI using weights derived via canonical correlation analysis.
